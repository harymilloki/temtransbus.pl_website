...
class HTCC_Admin {
    ...
    function htcc_settings_section_cb() {
        ...
        // $this->getApi()->debug(); ?>
        <hr>
        <?php if (!get_option('mobilemonkey_token')){?>
            <h5>Connect to your Facebook account</h5> 
        <?php } ?>
        <div class="row">
    ...
    public function htcc_page_load_cb() {
        ...
        <p class="description"><a target="_blank" href="https://mobilemonkey.com/wp-chatbot/pro/"> Pro Version has lot more features</a> </p>
