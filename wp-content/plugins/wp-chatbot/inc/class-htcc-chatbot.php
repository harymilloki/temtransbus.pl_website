...
class HTCC_Chatbot {
    ...
    /**
     * Checking saved eviroinment (fb_app_id) in DB.
     * If the user has never connected via FB connection button $stored_env == false.
     * 
     * In this case, make an additional request to the API MM
     * 
     * Otherwise, just take the value from DB
     */
    
    $stored_env = get_option('mobilemonkey_environment');
